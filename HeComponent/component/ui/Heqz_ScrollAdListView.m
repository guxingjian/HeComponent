...
@interface Heqz_ScrollAdListView()<UIScrollViewDelegate>
...
@implementation Heqz_ScrollAdListView
...
- (Heqz_PageControl *)pageControl{
    if(!_pageControl){
        _pageControl = [[Heqz_PageControl alloc] initWithFrame:CGRectZero];
        _pageControl.config = [Heqz_PageControlConfig defaultConfig];
