...
@implementation Heqz_SinglePixelView
...
@interface Heqz_SinglePixelHorizontalView()

@end

@implementation Heqz_SinglePixelHorizontalView
...
@implementation Heqz_SinglePixelVerticalView
