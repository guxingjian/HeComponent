...
@implementation Heqz_PageControlConfig

+ (instancetype)defaultConfig{
    Heqz_PageControlConfig* config = [[self alloc] init];
    config.dotWidth = 6;
    config.dotHeight = 6;
...
@implementation Heqz_PageControl
...
- (void)setConfig:(Heqz_PageControlConfig *)config{
    _config = config;
