...
#import "Heqz_ChartImageAnimatable.h"

@interface Heqz_ChartImageAnimatable()

@end

@implementation Heqz_ChartImageAnimatable

+ (instancetype)chartImageWithImage:(UIImage *)image
{
    Heqz_ChartImageAnimatable* chartImage = [[self alloc] init];
