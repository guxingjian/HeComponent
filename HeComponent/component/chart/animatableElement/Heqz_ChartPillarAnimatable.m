...
#import "Heqz_ChartPillarAnimatable.h"
#import "Heqz_ChartCommonFunc.h"

@interface Heqz_ChartPillarAnimatable()

@end

@implementation Heqz_ChartPillarAnimatable
...
- (void)addPillarModel:(Heqz_ChartPillarModel*)model pillarWidth:(CGFloat)pillarW posX:(CGFloat)posX
{
    ...
    if(model.tipText.length > 0)
    {
        CAShapeLayer* textShape = [Heqz_ChartCommonFunc boundingLayerWithText:model.tipText attributes:model.textAttri];
        if(textShape)
        {
