...
- (CALayer *)canvasLayer
{
    if(!_canvasLayer)
    {
        ...
        {
            Heqz_ChartLayer* chartLayer = [[Heqz_ChartLayer alloc] init];
...
- (void)showChartData
{
    if([self.canvasLayer isKindOfClass:[Heqz_ChartLayer class]])
    {
