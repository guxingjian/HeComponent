...
@interface SFChartPillarModel : NSObject

+ (instancetype)model;

// 柱的数值范围, 单位为原始数据
@property(nonatomic, assign)SFChartRange range;
...
@interface SFChartPillarDrawable : SFChartElement
...
@property(nonatomic, strong)NSArray<SFChartPillarModel*> * arrayPillar;
