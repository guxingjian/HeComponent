...
extern NSString* const Heqingzhao_ControlCategory_view;
extern NSString* const Heqingzhao_ControlCategory_label;
extern NSString* const Heqingzhao_ControlCategory_button;

@interface Heqingzhao_ThemeSkinManager : NSObject
...
extern NSString* const Heqingzhao_ThemeSkinChanged;
