...
@implementation Heqingzhao_TabbarAdjustPosition
...
{
    [Heqingzhao_TabbarAdjustPosition showHiddenTabWith:selectTab splitDis:tabDis containerScrollView:scroll animation:YES];
}
