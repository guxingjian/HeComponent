//
//  Heqz_MultiChannelTopBarTabItem.h
//  HeComponent
//
...
@interface Heqz_MultiChannelTopBarConfig : NSObject<NSSecureCoding>
...
@class Heqz_MultiChannelConfig;

@protocol Heqz_MultiChannelConfigProtocol <NSObject>
@required
...
@interface Heqz_MultiChannelConfig : NSObject<NSSecureCoding>
...
@property(nonatomic, strong)Heqz_MultiChannelTopBarConfig* topBarConfig;
@property(nonatomic, strong)id<Heqz_MultiChannelConfigProtocol> contentProvider;
...
+ (NSArray*)configArrayWithArray:(NSArray*)arrayConfig insertConfig:(Heqz_MultiChannelConfig*)config atIndex:(NSInteger (^)(Heqz_MultiChannelConfig* config, NSInteger index))indexBlock;
