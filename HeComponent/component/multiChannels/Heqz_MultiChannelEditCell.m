...
@interface Heqz_MultiChannelEditCell()

@property(nonatomic, strong)UIButton* deleteBtn;

@end

@implementation Heqz_MultiChannelEditCell
...
- (void)setConfig:(Heqz_MultiChannelConfig *)config{
    _config = config;
...
- (UIButton *)deleteBtn{
    if(!_deleteBtn){
        ...
        [_deleteBtn setImage:[Heqz_ImageLoader loadImage:@"label_delete"] forState:UIControlStateNormal];
